    ...
    <section class="h-[100vh] pt-[40px] bg-primary flex justify-center items-center">
        <article class="container relative bg-zinc-700 text-white h-[700px] max-h-[80%] rounded-[40px] py-10 px-32 flex justify-between items-center">
            ...
            <form action="{{route('register-user')}}" method="post" class="w-[40%] flex flex-col items-start text-base">
                ...
                <input class="mb-6 py-2 px-4 rounded-md w-full bg-primary " type="text" id="name" name="name" placeholder="Ex: Marcos Leonardo" />
                ...
                <input class="mb-6 py-2 px-4 rounded-md w-full bg-primary focus:ring-0" type="password" name="password" id="password" placeholder="Ex: marcox123@" />
