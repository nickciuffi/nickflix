...
<main class="bg-primary relative z-10">
    <section class="min-h-[100vh] pt-[100px] flex justify-center items-center">
           <article class="container bg-zinc-700 px-16 text-white min-h-[700px] rounded-[40px] w-[90%] relative py-20 flex justify-between items-center tablet:gap-20 tablet:flex-col tablet:justify-center">
