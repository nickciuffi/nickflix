...
<header
    class="w-full fixed top-0 left-0 min-h-[50px] flex items-center justify-center bg-zinc-700 text-white text-base z-20 shadow-xl">
            ...
            @if (UserController::isLogged())
                ...
                <li>
                    <form action="" method="get"
                        class="bg-zinc-500 rounded-md pr-2 flex items-center justify-center">
                        <input type="text" name="searchText"
                            class="bg-transparent overflow-hidden focus-visible:ring-0 focus-within:ring-0 focus:ring-0 py-1 px-2" />
